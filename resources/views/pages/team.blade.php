  ...
  <section class="bg-gray-900 text-gray-300">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
      <div class="mx-auto mb-8 max-w-screen-sm lg:mb-16">
        ...
        <p class="font-light text-gray-300 sm:text-xl dark:text-gray-400">Explore the whole collection of open-source
      ...
      <div class="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        <div class="text-center text-gray-300 dark:text-gray-400">
          ...
          <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-300 dark:text-white">
          ...
          <ul class="flex justify-center mt-4 space-x-4">
            ...
            <li>
              <a href="#" class="text-gray-300 dark:text-gray-300">
                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fill-rule="evenodd"
        ...
        <div class="text-center text-gray-300 dark:text-gray-400">
          <img class="mx-auto mb-4 w-36 h-36 rounded-full"
               src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/thomas-lean.png" alt="Leslie Avatar">
          <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-300 dark:text-white">
